    ...
    >
      <div className="space-y-4">
        <div>
          ...
          <input
            type="text"
            id="voucher"
            className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2.5 text-sm text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500"
            placeholder="Insira o codigo do cupom aqui"
            value={userInputCode}
      ...
      {isCouponApplied && coupon && (
        <div className="mt-4">
          ...
          <motion.div
            type="button"
            className="mt-2 flex w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 sm:w-auto"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
